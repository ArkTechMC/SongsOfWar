...
public abstract class AbstractFelinaEntity extends MonsterEntityBase implements EntityTextureProvider {
    public AbstractFelinaEntity(EntityType<? extends HostileEntity> entityType, World world) {
