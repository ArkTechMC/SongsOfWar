...
public class IgneousEntity extends MonsterEntityBase implements EntityTextureProvider {
    ...
    public Identifier getTextureId() {
        return new Identifier(SongsOfWar.MOD_ID, "textures/entity/igneous.png");
    }
}
