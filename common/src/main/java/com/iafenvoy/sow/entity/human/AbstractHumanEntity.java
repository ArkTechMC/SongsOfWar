...
public abstract class AbstractHumanEntity extends MonsterEntityBase implements EntityTextureProvider {
    protected AbstractHumanEntity(EntityType<? extends HostileEntity> entityType, World world) {
