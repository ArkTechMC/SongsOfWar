...
public class PeasPieBlock extends FoodBlockWithPiece {
    private static final List<VoxelShape> SHAPES = List.of(
            VoxelShapes.cuboid(0.5, 0, 0.125, 0.875, 0.25, 0.5),
            VoxelShapes.cuboid(0.125, 0, 0.125, 0.5, 0.25, 0.5),
            VoxelShapes.cuboid(0.125, 0, 0.5, 0.5, 0.25, 0.875),
            VoxelShapes.cuboid(0.5, 0, 0.5, 0.875, 0.25, 0.875)
    );
